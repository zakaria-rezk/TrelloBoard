...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/zekor/trello-board/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/zekor/trello-board/node_modules/devalue/index.js';
import destr from 'file://C:/Users/zekor/trello-board/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash } from 'file://C:/Users/zekor/trello-board/node_modules/ufo/dist/index.mjs';
import { hash } from 'file://C:/Users/zekor/trello-board/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://C:/Users/zekor/trello-board/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/zekor/trello-board/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/zekor/trello-board/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/zekor/trello-board/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://C:/Users/zekor/trello-board/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/zekor/trello-board/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/zekor/trello-board/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/zekor/trello-board/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/zekor/trello-board/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/zekor/trello-board/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://C:/Users/zekor/trello-board/node_modules/consola/dist/index.mjs';
import devalue from 'file://C:/Users/zekor/trello-board/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file://C:/Users/zekor/trello-board/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file://C:/Users/zekor/trello-board/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/Users/zekor/trello-board/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/zekor/trello-board/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/zekor/trello-board/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\zekor\\trello-board","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\zekor\\trello-board\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\zekor\\trello-board\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\zekor\\trello-board\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\zekor\\trello-board\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const rootDir = "C:/Users/zekor/trello-board";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _od2OrLiOe1 = (nitroApp) => {
...
const _lazy_ZypvlD = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_ZypvlD, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ZypvlD, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/zekor/trello-board/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
